...
<head>
    <title>Code coverage report for http-duplex.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> http-duplex.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.07% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>399/469</span>
            </div>
...
<a name='L470'></a><a href='#L470'>470</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
class HttpDuplex extends events_1.default {
     ...
     * }).listen(80);
     */
<span class="fstat-no" title="function not covered" >    constructor(input, output) {</span>
<span class="cstat-no" title="statement not covered" >        super();</span>
<span class="cstat-no" title="statement not covered" >        this.req = input;</span>
<span class="cstat-no" title="statement not covered" >        this.res = output;</span>
<span class="cstat-no" title="statement not covered" >        // request / input proxy events</span>
<span class="cstat-no" title="statement not covered" >        ["data", "end", "error", "close"].forEach((name) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            this.req.on(name, this.emit.bind(this, name));</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >        // respone / output proxy events</span>
<span class="cstat-no" title="statement not covered" >        ["error", "drain"].forEach((name) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            this.res.on(name, this.emit.bind(this, name));</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    end() {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error("Method not implemented.");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >        throw new Error("Method not implemented.");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    get complete<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.complete;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
    get connection<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.connection;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
    get headers<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.headers;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get httpVersion<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.httpVersion;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get httpVersionMajor<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.httpVersionMajor;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get httpVersionMinor<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.httpVersionMinor;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get method<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.method;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get readable<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.readable;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @readonly
     */
    get socket<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.socket;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
    get statusCode<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.res.statusCode;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    set statusCode<span class="fstat-no" title="function not covered" >(val) {</span>
<span class="cstat-no" title="statement not covered" >        this.res.statusCode = val;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
    get statusMessage<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.res.statusMessage;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    set statusMessage<span class="fstat-no" title="function not covered" >(val) {</span>
<span class="cstat-no" title="statement not covered" >        this.res.statusMessage = val;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
    get trailers<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.trailers;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     * Request URL string.
     ...
     * @readonly
     */
    get url<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.req.url;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    // output / response wrapping
    get writable<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >        return this.res.writable;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    writeHead(statusCode, statusMessage, headers) {</span>
<span class="cstat-no" title="statement not covered" >        this.res.writeHead(statusCode, statusMessage, headers);</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
     ...
     * request.uncork();
     */
<span class="fstat-no" title="function not covered" >    cork() {</span>
<span class="cstat-no" title="statement not covered" >        this.res.connection?.cork();</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    uncork() {</span>
<span class="cstat-no" title="statement not covered" >        this.res.connection?.uncork();</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
["pause", "resume", "setEncoding"].forEach(function (name) {
    HttpDuplex.prototype[name] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        // eslint-disable-next-line prefer-rest-params</span>
<span class="cstat-no" title="statement not covered" >        return this.req[name].apply(this.req, Array.from(arguments));</span>
<span class="cstat-no" title="statement not covered" >    };</span>
});
...
[
    ...
    HttpDuplex.prototype[name] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        // eslint-disable-next-line prefer-rest-params</span>
<span class="cstat-no" title="statement not covered" >        return this.res[name].apply(this.res, Array.from(arguments));</span>
<span class="cstat-no" title="statement not covered" >    };</span>
});
/**
 ...
 * @memberof HttpDuplex
 */
HttpDuplex.prototype.destroy = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    this.req.destroy();</span>
<span class="cstat-no" title="statement not covered" >    this.res.destroy();</span>
<span class="cstat-no" title="statement not covered" >};</span>
/**
