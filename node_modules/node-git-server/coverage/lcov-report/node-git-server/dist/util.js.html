...
<head>
    <title>Code coverage report for node-git-server/dist/util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-git-server/dist</a> util.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">93.66% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>133/142</span>
            </div>
...
function serviceRespond(dup, service, repoLocation, res) {
    ...
    const cmd = isWin
<span class="branch-0 cbranch-no" title="branch not covered" >        ? ["</span>git", service, "--stateless-rpc", "--advertise-refs", repoLocation]
...
<span class="cstat-no" title="statement not covered" >    });</span>
    ...
    else if (!exists) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
