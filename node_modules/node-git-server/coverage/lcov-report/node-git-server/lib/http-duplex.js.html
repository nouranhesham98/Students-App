...
<head>
    <title>Code coverage report for node-git-server/lib/http-duplex.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-git-server/lib</a> http-duplex.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">69.77% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>30/43</span>
            </div>
...
<a name='L520'></a><a href='#L520'>520</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const EventEmitter = require('events');
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    se</span>t statusCode(val) {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ge</span>t statusMessage() {
<span class="cstat-no" title="statement not covered" >        return this.res.statusMessage;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    se</span>t statusMessage(val) {
...
<span class="fstat-no" title="function not covered" >    ge</span>t writable() {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    wr</span>iteHead(statusCode, statusMessage, headers) {
...
&nbsp;
     ...
     * request.uncork();
     */
<span class="fstat-no" title="function not covered" >    co</span>rk() {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    un</span>cork() {
...
['pause', 'resume', 'setEncoding'].forEach(function (name) {
    HttpDuplex.prototype[name] = <span class="fstat-no" title="function not covered" >fu</span>nction () {
 ...
 * @memberof HttpDuplex
 */
HttpDuplex.prototype.destroy = <span class="fstat-no" title="function not covered" >fu</span>nction () {
