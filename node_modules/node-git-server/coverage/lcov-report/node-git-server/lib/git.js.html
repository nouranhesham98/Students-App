...
<head>
    <title>Code coverage report for node-git-server/lib/git.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-git-server/lib</a> git.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">61.46% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>118/192</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>47/96</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">65.29% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>111/170</span>
            </div>
...
<a name='L472'></a><a href='#L472'>472</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    ...
    this.autoCreate = options.autoCreate === false ? <span class="branch-0 cbranch-no" title="branch not covered" >false </span>: true;
...
&nbsp;
  ...
  create(repo, callback) {
      var self = this;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function') <span class="cstat-no" title="statement not covered" >callback = <span class="fstat-no" title="function not covered" >fu</span>nction () {};</span>
&nbsp;
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (self.checkout) {
<span class="cstat-no" title="statement not covered" >              ps = spawn('git', [ 'init', dir ]);</span>
          }
          else {
              ps = spawn('git', [ 'init', '--bare', dir ]);
          }
&nbsp;
          ps.stderr.on('data', <span class="fstat-no" title="function not covered" >fu</span>nction (buf) { <span class="cstat-no" title="statement not covered" >error += buf; </span>});
          onExit(ps, function (code) {
              ...
              else <span class="missing-if-branch" title="if path not taken" >I</span>if (code) <span class="cstat-no" title="statement not covered" >callback(error || true);</span>
              else callback(null);
          });
      }
  }
  ...
  getType(service) {
    switch(service) {
      case 'upload-pack':
        return 'fetch';
<span class="branch-1 cbranch-no" title="branch not covered" >      case 'receive-pack':</span>
<span class="cstat-no" title="statement not covered" >        return 'push';</span>
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!m) <span class="cstat-no" title="statement not covered" >return false;</span>
            <span class="missing-if-branch" title="if path not taken" >I</span>if (/\.\./.test(m[1])) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
            var repo = m[1];
            var params = qs.parse(u.query);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!params.service) {
<span class="cstat-no" title="statement not covered" >                res.statusCode = 400;</span>
<span class="cstat-no" title="statement not covered" >                res.end('service parameter required');</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
            var service = params.service.replace(/^git-/, '');
            <span class="missing-if-branch" title="if path not taken" >I</span>if (services.indexOf(service) &lt; 0) {
<span class="cstat-no" title="statement not covered" >                res.statusCode = 405;</span>
<span class="cstat-no" title="statement not covered" >                res.end('service not available');</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                res.setHeader("WWW-Authenticate", 'Basic realm="authorization needed"');</span>
<span class="cstat-no" title="statement not covered" >                res.writeHead(401);</span>
<span class="cstat-no" title="statement not covered" >                res.end(typeof error === 'string' ? error : error.toString());</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
              } else {
...
&nbsp;
        ...
        function(req, res) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (req.method !== 'GET') return false;
&nbsp;
            var u = <span class="cstat-no" title="statement not covered" >url.parse(req.url);</span>
            var m = <span class="cstat-no" title="statement not covered" >u.pathname.match(/^\/(.+)\/HEAD$/);</span>
<span class="cstat-no" title="statement not covered" >            if (!m) <span class="cstat-no" title="statement not covered" >return false;</span></span>
<span class="cstat-no" title="statement not covered" >            if (/\.\./.test(m[1])) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
            var self = <span class="cstat-no" title="statement not covered" >this;</span>
            var repo = <span class="cstat-no" title="statement not covered" >m[1];</span>
&nbsp;
            var next = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
                const file = <span class="cstat-no" title="statement not covered" >self.dirMap(path.join(m[1], 'HEAD'));</span>
<span class="cstat-no" title="statement not covered" >                self.exists(file, <span class="fstat-no" title="function not covered" >(e</span>x) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (ex) <span class="cstat-no" title="statement not covered" >fs.createReadStream(file).pipe(res);</span></span>
                    else {
<span class="cstat-no" title="statement not covered" >                        res.statusCode = 404;</span>
<span class="cstat-no" title="statement not covered" >                        res.end('not found');</span>
                    }
                });
            };
&nbsp;
<span class="cstat-no" title="statement not covered" >            self.exists(repo, <span class="fstat-no" title="function not covered" >(e</span>x) =&gt; {</span>
                const anyListeners = <span class="cstat-no" title="statement not covered" >self.listeners('head').length &gt; 0;</span>
                const dup = <span class="cstat-no" title="statement not covered" >new httpDuplex(req, res);</span>
<span class="cstat-no" title="statement not covered" >                dup.exists = ex;</span>
<span class="cstat-no" title="statement not covered" >                dup.repo = repo;</span>
<span class="cstat-no" title="statement not covered" >                dup.cwd = self.dirMap(repo);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                dup.accept = dup.emit.bind(dup, 'accept');</span>
<span class="cstat-no" title="statement not covered" >                dup.reject = dup.emit.bind(dup, 'reject');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                dup.once('reject', <span class="fstat-no" title="function not covered" >(c</span>ode) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    dup.statusCode = code || 500;</span>
<span class="cstat-no" title="statement not covered" >                    dup.end();</span>
                });
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!ex &amp;&amp; self.autoCreate) {</span>
<span class="cstat-no" title="statement not covered" >                    dup.once('accept', <span class="fstat-no" title="function not covered" >(d</span>ir) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        self.create(dir || repo, next);</span>
                    });
<span class="cstat-no" title="statement not covered" >                    self.emit('head', dup);</span>
<span class="cstat-no" title="statement not covered" >                    if (!anyListeners) <span class="cstat-no" title="statement not covered" >dup.accept();</span></span>
                } else <span class="cstat-no" title="statement not covered" >if (!ex) {</span>
<span class="cstat-no" title="statement not covered" >                    res.statusCode = 404;</span>
<span class="cstat-no" title="statement not covered" >                    res.setHeader('content-type', 'text/plain');</span>
<span class="cstat-no" title="statement not covered" >                    res.end('repository not found');</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    dup.once('accept', next);</span>
<span class="cstat-no" title="statement not covered" >                    self.emit('head', dup);</span>
<span class="cstat-no" title="statement not covered" >                    if (!anyListeners) <span class="cstat-no" title="statement not covered" >dup.accept();</span></span>
                }
            });
        ...
        function(req, res) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method !== 'POST') <span class="cstat-no" title="statement not covered" >return false;</span>
...
<span class="fstat-no" title="function not covered" >        (r</span>eq, res) =&gt; {
<span class="cstat-no" title="statement not covered" >            if (req.method !== 'GET' &amp;&amp; req.method !== 'POST') {</span>
<span class="cstat-no" title="statement not covered" >                res.statusCode = 405;</span>
<span class="cstat-no" title="statement not covered" >                res.end('method not supported');</span>
            } else {
...
<span class="cstat-no" title="statement not covered" >            res.end('not found');</span>
      ...
      var self = this;
      (function next(ix) {
          var done = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >              next(ix + 1);</span>
          };
  ...
  listen(port, options, callback) {
      const self = this;
      <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof options == 'function' || !options) {
        callback = options;
        options = { type: 'http' };
      }
      const createServer = options.type == 'http' ? http.createServer : <span class="branch-1 cbranch-no" title="branch not covered" >https.createServer.bind(this, options);</span>
&nbsp;
  ...
  close() {
      return new Promise((resolve, reject) =&gt; {
          this.server.close((err) =&gt; {
              err ? <span class="branch-0 cbranch-no" title="branch not covered" >reject(err) </span>: resolve();
          });
      });
  }
}
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Apr 24 2021 20:53:19 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
