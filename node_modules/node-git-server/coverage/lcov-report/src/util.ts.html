...
<head>
    <title>Code coverage report for src/util.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> util.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.73% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>162/171</span>
            </div>
...
&nbsp;
  const cmd = isWin
<span class="branch-0 cbranch-no" title="branch not covered" >    ? ['git', service, '--stateless-rpc', '--advertise-refs', repoLocation]</span>
    : ['git-' + service, '--stateless-rpc', '--advertise-refs', repoLocation];
&nbsp;
  const ps = spawn(cmd[0], cmd.slice(1));
&nbsp;
  ps.on('error', (err) =&gt; {
<span class="cstat-no" title="statement not covered" >    dup.emit(</span>
<span class="cstat-no" title="statement not covered" >      'error',</span>
<span class="cstat-no" title="statement not covered" >      new Error(`${err.message} running command ${cmd.join(' ')}`)</span>
