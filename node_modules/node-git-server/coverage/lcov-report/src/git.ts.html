...
<head>
    <title>Code coverage report for src/git.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> git.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">84.82% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>464/547</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>50/76</span>
            </div>
...
<a name='L548'></a><a href='#L548'>548</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >    else return new Promise&lt;string[]&gt;((res, rej) =&gt; execf(res, rej));</span></span>
  }
  /**
...
&nbsp;
      if (self.checkout) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >          return;</span>
        } else if (code) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >          callback(new Error(_error));</span>
        } else {
          callback();
        }
      });
...
<span class="branch-0 cbranch-no" title="branch not covered" >      callback = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        return;</span>
...
&nbsp;
  ...
  getType(service: string): string {
    switch (service) {
      case 'upload-pack':
        return 'fetch';
<span class="branch-0 cbranch-no" title="branch not covered" >      case 'receive-pack':</span>
...
&nbsp;
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const u = url.parse(req?.url<span class="branch-0 cbranch-no" title="branch not covered" > || '')</span>;
        const m = u.pathname?.match(/\/(.+)\/info\/refs$/);
        if (!m) <span class="branch-0 cbranch-no" title="branch not covered" >return false;</span>
        if (/\.\./.test(m[1])) <span class="branch-0 cbranch-no" title="branch not covered" >return false;</span>
&nbsp;
        const repo = m[1];
        const params = qs.parse(u?.query<span class="branch-0 cbranch-no" title="branch not covered" > || '')</span>;
        if (!params.service || typeof params.service !== 'string') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
&nbsp;
        if (services.indexOf(service) &lt; 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >            res.setHeader(</span>
<span class="cstat-no" title="statement not covered" >              'WWW-Authenticate',</span>
<span class="cstat-no" title="statement not covered" >              'Basic realm="authorization needed"'</span>
<span class="cstat-no" title="statement not covered" >            );</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >              : new Promise&lt;[string | undefined, string | undefined]&gt;(</span>
<span class="cstat-no" title="statement not covered" >                  (resolve) =&gt; basicAuth(req, res, (u, p) =&gt; resolve([u, p]))</span>
                );
&nbsp;
...
<span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ></span></span>
        ...
        const m = u.pathname<span class="branch-0 cbranch-no" title="branch not covered" >?.match(</span>/^\/(.+)\/HEAD$/);
        if (!m) <span class="branch-0 cbranch-no" title="branch not covered" >return false;</span>
<span class="cstat-no" title="statement not covered" >        if (/\.\./.test(m[1])) return false;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const repo = m[1];</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const next = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >          const file = this.dirMap(path.join(m[1], 'HEAD'));</span>
<span class="cstat-no" title="statement not covered" >          const exists = this.exists(file);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          if (exists) {</span>
<span class="cstat-no" title="statement not covered" >            fs.createReadStream(file).pipe(res);</span>
...
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const exists = this.exists(repo);</span>
<span class="cstat-no" title="statement not covered" >        const anyListeners = self.listeners('head').length &gt; 0;</span>
<span class="cstat-no" title="statement not covered" >        const dup = new HttpDuplex(req, res);</span>
<span class="cstat-no" title="statement not covered" >        dup.exists = exists;</span>
<span class="cstat-no" title="statement not covered" >        dup.repo = repo;</span>
<span class="cstat-no" title="statement not covered" >        dup.cwd = this.dirMap(repo);</span>
<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        dup.once('reject', (code: number) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" ></span>
        if (!exists &amp;&amp; self.autoCreate) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >          dup.once('accept', (dir: string) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >          if (!anyListeners) dup.accept();</span>
<span class="cstat-no" title="statement not covered" >        } else if (!exists) {</span>
<span class="cstat-no" title="statement not covered" >          res.statusCode = 404;</span>
<span class="cstat-no" title="statement not covered" >          res.setHeader('content-type', 'text/plain');</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
      ...
      (req: http.IncomingMessage, res: http.ServerResponse) =&gt; {
        if (req.method !== 'POST') <span class="branch-0 cbranch-no" title="branch not covered" >return false;</span>
...
<span class="fstat-no" title="function not covered" >      (req: http.IncomingMessage, res: http.ServerResponse) =&gt; {</span>
...
&nbsp;
    const createServer =
      options.type == 'http'
        ? http.createServer
<span class="branch-0 cbranch-no" title="branch not covered" >        : https.createServer.bind(this, options);</span>
&nbsp;
  ...
  close(): Promise&lt;string&gt; {
    return new Promise&lt;string&gt;((resolve, reject) =&gt; {
      this.server?.close((err) =&gt; {
        err <span class="branch-0 cbranch-no" title="branch not covered" >? reject(err) </span>: resolve('Success');
      });
    });
  }
}
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Jan 02 2022 18:34:27 GMT-0800 (Pacific Standard Time)
            </div>
