...
<head>
    <title>Code coverage report for src/http-duplex.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> http-duplex.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">81.88% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>235/287</span>
            </div>
...
<span class="fstat-no" title="function not covered" >  setHeader(arg0: string, arg1: string) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="fstat-no" title="function not covered" >  end(reason?: any) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
<span class="cstat-no" title="statement not covered" >  }</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="fstat-no" title="function not covered" >  reject(code: number, msg: string) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >  get complete() {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  get connection() {</span>
...
&nbsp;
   ...
   * @readonly
   */
<span class="fstat-no" title="function not covered" >  get httpVersion() {</span>
...
&nbsp;
   ...
   * @readonly
   */
<span class="fstat-no" title="function not covered" >  get httpVersionMajor() {</span>
...
&nbsp;
   ...
   * @readonly
   */
<span class="fstat-no" title="function not covered" >  get httpVersionMinor() {</span>
...
&nbsp;
   ...
   * @readonly
   */
<span class="fstat-no" title="function not covered" >  get readable() {</span>
...
&nbsp;
   ...
   * @readonly
   */
<span class="fstat-no" title="function not covered" >  get socket() {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  get statusCode() {</span>
<span class="cstat-no" title="statement not covered" >    return this.res.statusCode;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  set statusCode(val) {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  get statusMessage() {</span>
<span class="cstat-no" title="statement not covered" >    return this.res.statusMessage;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  set statusMessage(val) {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  get trailers() {</span>
...
<span class="fstat-no" title="function not covered" >  get writable() {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  writeHead(statusCode: number, statusMessage: string, headers: string[]) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.res.socket?.cork();</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    this.res.socket?.uncork();</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
}
&nbsp;
...
['pause', 'resume', 'setEncoding'].forEach(function (name) {
  (HttpDuplex.prototype as any)[name] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    // eslint-disable-next-line prefer-rest-params</span>
<span class="cstat-no" title="statement not covered" >    return (this.req as any)[name].apply(this.req, Array.from(arguments));</span>
  };
});
&nbsp;
...
[
  ...
  (HttpDuplex.prototype as any)[name] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    // eslint-disable-next-line prefer-rest-params</span>
<span class="cstat-no" title="statement not covered" >    return (this.res as any)[name].apply(this.res, Array.from(arguments));</span>
  };
});
&nbsp;
/**
